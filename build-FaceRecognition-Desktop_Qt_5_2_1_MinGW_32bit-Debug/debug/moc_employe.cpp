...
#include "../../FaceRecognition/employe.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Employe_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 32, 0)
    ...
    "Employe\0on_Authentifier_clicked\0\0"
};
...
void Employe::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_Authentifier_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject Employe::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_Employe.data,
      qt_meta_data_Employe,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Employe.stringdata))
